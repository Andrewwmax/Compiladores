...
import gerador.Item;
import gerador.TipoOperador;
import gerador.Operador;
import gerador.Operando;
import gerador.TipoElemento;
...
public class Compilador implements CompiladorConstants {
   ...
   public static void main(String args[])  throws ParseException  {
      ...
      try {
         compilador = new Compilador(new FileInputStream("exemplos/15.spc"));
  ...
  static final public void declaracao(ListaComandosAltoNivel listaComandosAltoNivel) throws ParseException {
                                                                  Token t; TipoDado tipo; Simbolo simbolo; ComandoAltoNivel cmd = null; Expressao expressao;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NUMERO:
  ...
  static final public void se(ListaComandosAltoNivel listaComandosAltoNivel) throws ParseException {
                                                           ComandoAltoNivel cmd = null;Expressao expressao;ListaComandosAltoNivel listaComandosAltoNivelTrue = new ListaComandosAltoNivel();
    jj_consume_token(SE);
    jj_consume_token(AP);
    expressao = expressao();
    jj_consume_token(FP);
  ...
  static final public void exibe(ListaComandosAltoNivel listaComandosAltoNivel) throws ParseException {
                                                             Expressao expressao;ComandoAltoNivel cmd = null;
  ...
  static final public void termo2(Expressao expressao) throws ParseException {
                                    Token t; Item item; TipoOperador tipoOperador;
    termo3(expressao);
    label_7:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
